...
std::string convert(unsigned long long x)
{
  ...
  if (x >= 20 && x < 100)
  {
    ...
    {
    case 2:
      return "Twenty" + strOnes;
    case 3:
      return "Thirty" + strOnes;
    case 4:
      return "Forty" + strOnes; // <= often misspelt/misspelled ;)
    case 5:
      return "Fifty" + strOnes;
    case 6:
      return "Sixty" + strOnes;
    case 7:
      return "Seventy" + strOnes;
    case 8:
      return "Eighty" + strOnes;
    case 9:
      return "Ninety" + strOnes;
    default:
      break; // never reached
    }
  }
...
int main()
{
  ...
  while (tests--)
  {
    unsigned long long x = tests;
    std::cout << convert(x) << std::endl;
    ans += convert(x).length();
  }
